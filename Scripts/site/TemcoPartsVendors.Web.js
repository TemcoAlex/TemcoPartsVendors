...
(function (TemcoPartsVendors) {
    ...
    })(Administration = TemcoPartsVendors.Administration || (TemcoPartsVendors.Administration = {}));
...
(function (TemcoPartsVendors) {
    ...
    })(Common = TemcoPartsVendors.Common || (TemcoPartsVendors.Common = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var Common;
...
(function (TemcoPartsVendors) {
    ...
    })(Membership = TemcoPartsVendors.Membership || (TemcoPartsVendors.Membership = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var Membership;
...
(function (TemcoPartsVendors) {
    ...
    })(Organization = TemcoPartsVendors.Organization || (TemcoPartsVendors.Organization = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var Organization;
...
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        CompanyForm.formKey = 'PartsVendors.Company';
        PartsVendors.CompanyForm = CompanyForm;
        [['OrgKey', function () { return Serenity.StringEditor; }], ['OrgName', function () { return Serenity.StringEditor; }], ['OrgAddress', function () { return Serenity.StringEditor; }], ['OrgPhone', function () { return Serenity.StringEditor; }], ['OrgFaax', function () { return Serenity.StringEditor; }], ['OrgpoUseShpgAddr', function () { return Serenity.BooleanEditor; }], ['OrgrfqUseShpgAddr', function () { return Serenity.BooleanEditor; }], ['OrgListOrder', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(CompanyForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
...
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        var CompanyRow;
        (function (CompanyRow) {
            CompanyRow.idProperty = 'Orgid';
            CompanyRow.nameProperty = 'OrgKey';
            CompanyRow.localTextPrefix = 'PartsVendors.Company';
            var Fields;
            (function (Fields) {
            })(Fields = CompanyRow.Fields || (CompanyRow.Fields = {}));
            ['Orgid', 'OrgKey', 'OrgName', 'OrgAddress', 'OrgPhone', 'OrgFaax', 'OrgpoUseShpgAddr', 'OrgrfqUseShpgAddr', 'OrgListOrder'].forEach(function (x) { return Fields[x] = x; });
        })(CompanyRow = PartsVendors.CompanyRow || (PartsVendors.CompanyRow = {}));
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        (function (CompanyService) {
            CompanyService.baseUrl = 'PartsVendors/Company';
            var Methods;
            (function (Methods) {
        ...
        })(CompanyService = PartsVendors.CompanyService || (PartsVendors.CompanyService = {}));
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
...
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var CustomerDefineRow;
        (function (CustomerDefineRow) {
            CustomerDefineRow.idProperty = 'Gprefid';
            CustomerDefineRow.nameProperty = 'GprefKey';
            CustomerDefineRow.localTextPrefix = 'PartsVendors.CustomerDefine';
            var Fields;
            (function (Fields) {
            })(Fields = CustomerDefineRow.Fields || (CustomerDefineRow.Fields = {}));
            ['Gprefid', 'GprefKey', 'GprefText1', 'GprefText2', 'GprefText3', 'GprefText4', 'GprefText5', 'GprefBool1', 'GprefBool2', 'GprefBool3', 'GprefBool4', 'GprefInt1', 'GprefText6', 'GprefText7', 'GprefText8', 'GprefText9', 'GprefText10'].forEach(function (x) { return Fields[x] = x; });
        })(CustomerDefineRow = PartsVendors.CustomerDefineRow || (PartsVendors.CustomerDefineRow = {}));
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var CustomerDefineService;
        (function (CustomerDefineService) {
            CustomerDefineService.baseUrl = 'PartsVendors/CustomerDefine';
            var Methods;
            (function (Methods) {
            })(Methods = CustomerDefineService.Methods || (CustomerDefineService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                CustomerDefineService[x] = function (r, s, o) { return Q.serviceRequest(CustomerDefineService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = CustomerDefineService.baseUrl + '/' + x;
            });
        })(CustomerDefineService = PartsVendors.CustomerDefineService || (PartsVendors.CustomerDefineService = {}));
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var ExchangeRateForm = (function (_super) {
        ...
        ExchangeRateForm.formKey = 'PartsVendors.ExchangeRate';
        PartsVendors.ExchangeRateForm = ExchangeRateForm;
        [['CurCurrencyName', function () { return Serenity.StringEditor; }], ['CurExchangeRate', function () { return Serenity.DecimalEditor; }], ['CurCurrencyChar', function () { return Serenity.StringEditor; }], ['CurFormat', function () { return Serenity.StringEditor; }], ['CurFormatExt', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(ExchangeRateForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        (function (ExchangeRateRow) {
            ExchangeRateRow.idProperty = 'Curid';
            ExchangeRateRow.nameProperty = 'CurCurrencyName';
            ExchangeRateRow.localTextPrefix = 'PartsVendors.ExchangeRate';
            var Fields;
            (function (Fields) {
            })(Fields = ExchangeRateRow.Fields || (ExchangeRateRow.Fields = {}));
            ['Curid', 'CurCurrencyName', 'CurExchangeRate', 'CurCurrencyChar', 'CurFormat', 'CurFormatExt'].forEach(function (x) { return Fields[x] = x; });
        })(ExchangeRateRow = PartsVendors.ExchangeRateRow || (PartsVendors.ExchangeRateRow = {}));
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        (function (ExchangeRateService) {
            ExchangeRateService.baseUrl = 'PartsVendors/ExchangeRate';
            var Methods;
            (function (Methods) {
            })(Methods = ExchangeRateService.Methods || (ExchangeRateService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ExchangeRateService[x] = function (r, s, o) { return Q.serviceRequest(ExchangeRateService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = ExchangeRateService.baseUrl + '/' + x;
            });
        })(ExchangeRateService = PartsVendors.ExchangeRateService || (PartsVendors.ExchangeRateService = {}));
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
...
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        ShipmentForm.formKey = 'PartsVendors.Shipment';
        PartsVendors.ShipmentForm = ShipmentForm;
        [['ShipMethod', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(ShipmentForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        (function (ShipmentRow) {
            ShipmentRow.idProperty = 'Shipid';
            ShipmentRow.nameProperty = 'ShipMethod';
            ShipmentRow.localTextPrefix = 'PartsVendors.Shipment';
            var Fields;
            (function (Fields) {
            })(Fields = ShipmentRow.Fields || (ShipmentRow.Fields = {}));
            ['Shipid', 'ShipMethod'].forEach(function (x) { return Fields[x] = x; });
        })(ShipmentRow = PartsVendors.ShipmentRow || (PartsVendors.ShipmentRow = {}));
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        (function (ShipmentService) {
            ShipmentService.baseUrl = 'PartsVendors/Shipment';
            var Methods;
            (function (Methods) {
            })(Methods = ShipmentService.Methods || (ShipmentService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ShipmentService[x] = function (r, s, o) { return Q.serviceRequest(ShipmentService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = ShipmentService.baseUrl + '/' + x;
            });
        })(ShipmentService = PartsVendors.ShipmentService || (PartsVendors.ShipmentService = {}));
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        TypeForm.formKey = 'PartsVendors.Type';
        PartsVendors.TypeForm = TypeForm;
        [['TypeType', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(TypeForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        (function (TypeRow) {
            ...
            ['Typeid', 'TypeType'].forEach(function (x) { return Fields[x] = x; });
        })(TypeRow = PartsVendors.TypeRow || (PartsVendors.TypeRow = {}));
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        (function (TypeService) {
            TypeService.baseUrl = 'PartsVendors/Type';
            var Methods;
            (function (Methods) {
            })(Methods = TypeService.Methods || (TypeService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                TypeService[x] = function (r, s, o) { return Q.serviceRequest(TypeService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = TypeService.baseUrl + '/' + x;
            });
        })(TypeService = PartsVendors.TypeService || (PartsVendors.TypeService = {}));
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        UnitsForm.formKey = 'PartsVendors.Units';
        PartsVendors.UnitsForm = UnitsForm;
        [['UnUseUnits', function () { return Serenity.StringEditor; }], ['UnPurchUnits', function () { return Serenity.StringEditor; }], ['UnConvUnits', function () { return Serenity.DecimalEditor; }]].forEach(function (x) { return Object.defineProperty(UnitsForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        (function (UnitsRow) {
            ...
            ['Unid', 'UnUseUnits', 'UnPurchUnits', 'UnConvUnits'].forEach(function (x) { return Fields[x] = x; });
        })(UnitsRow = PartsVendors.UnitsRow || (PartsVendors.UnitsRow = {}));
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        ...
        (function (UnitsService) {
            UnitsService.baseUrl = 'PartsVendors/Units';
            var Methods;
            (function (Methods) {
            })(Methods = UnitsService.Methods || (UnitsService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                UnitsService[x] = function (r, s, o) { return Q.serviceRequest(UnitsService.baseUrl + '/' + x, r, s, o); };
...
(function (TemcoPartsVendors) {
    ...
    })(Authorization = TemcoPartsVendors.Authorization || (TemcoPartsVendors.Authorization = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var Administration;
...
(function (TemcoPartsVendors) {
    ...
    TemcoPartsVendors.BasicProgressDialog = BasicProgressDialog;
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new TemcoPartsVendors.BasicProgressDialog();
...
(function (TemcoPartsVendors) {
    ...
    })(DialogUtils = TemcoPartsVendors.DialogUtils || (TemcoPartsVendors.DialogUtils = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var Common;
...
(function (TemcoPartsVendors) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = TemcoPartsVendors.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = TemcoPartsVendors.LanguageList || (TemcoPartsVendors.LanguageList = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var Common;
...
(function (TemcoPartsVendors) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('TemcoPartsVendors');
        Serenity.EntityDialog.defaultLanguageList = TemcoPartsVendors.LanguageList.getValue;
    })(ScriptInitialization = TemcoPartsVendors.ScriptInitialization || (TemcoPartsVendors.ScriptInitialization = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var Common;
    ...
    (function (PartsVendors) {
        var CompanyDialog = (function (_super) {
            ...
            function CompanyDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new PartsVendors.CompanyForm(_this.idPrefix);
                return _this;
            }
            CompanyDialog.prototype.getFormKey = function () { return PartsVendors.CompanyForm.formKey; };
            CompanyDialog.prototype.getIdProperty = function () { return PartsVendors.CompanyRow.idProperty; };
            CompanyDialog.prototype.getLocalTextPrefix = function () { return PartsVendors.CompanyRow.localTextPrefix; };
            CompanyDialog.prototype.getNameProperty = function () { return PartsVendors.CompanyRow.nameProperty; };
            CompanyDialog.prototype.getService = function () { return PartsVendors.CompanyService.baseUrl; };
        ...
        PartsVendors.CompanyDialog = CompanyDialog;
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    ...
    (function (PartsVendors) {
        var CompanyGrid = (function (_super) {
            ...
            CompanyGrid.prototype.getColumnsKey = function () { return 'PartsVendors.Company'; };
            CompanyGrid.prototype.getDialogType = function () { return PartsVendors.CompanyDialog; };
            CompanyGrid.prototype.getIdProperty = function () { return PartsVendors.CompanyRow.idProperty; };
            CompanyGrid.prototype.getLocalTextPrefix = function () { return PartsVendors.CompanyRow.localTextPrefix; };
            CompanyGrid.prototype.getService = function () { return PartsVendors.CompanyService.baseUrl; };
            return CompanyGrid;
        }(Serenity.EntityGrid));
        CompanyGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], CompanyGrid);
        PartsVendors.CompanyGrid = CompanyGrid;
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var CustomerDefineDialog = (function (_super) {
            __extends(CustomerDefineDialog, _super);
            function CustomerDefineDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new PartsVendors.CustomerDefineForm(_this.idPrefix);
                return _this;
            }
            CustomerDefineDialog.prototype.getFormKey = function () { return PartsVendors.CustomerDefineForm.formKey; };
            CustomerDefineDialog.prototype.getIdProperty = function () { return PartsVendors.CustomerDefineRow.idProperty; };
            CustomerDefineDialog.prototype.getLocalTextPrefix = function () { return PartsVendors.CustomerDefineRow.localTextPrefix; };
            CustomerDefineDialog.prototype.getNameProperty = function () { return PartsVendors.CustomerDefineRow.nameProperty; };
            CustomerDefineDialog.prototype.getService = function () { return PartsVendors.CustomerDefineService.baseUrl; };
            return CustomerDefineDialog;
        }(Serenity.EntityDialog));
        CustomerDefineDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], CustomerDefineDialog);
        PartsVendors.CustomerDefineDialog = CustomerDefineDialog;
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var CustomerDefineGrid = (function (_super) {
            __extends(CustomerDefineGrid, _super);
            function CustomerDefineGrid(container) {
                return _super.call(this, container) || this;
            }
            CustomerDefineGrid.prototype.getColumnsKey = function () { return 'PartsVendors.CustomerDefine'; };
            CustomerDefineGrid.prototype.getDialogType = function () { return PartsVendors.CustomerDefineDialog; };
            CustomerDefineGrid.prototype.getIdProperty = function () { return PartsVendors.CustomerDefineRow.idProperty; };
            CustomerDefineGrid.prototype.getLocalTextPrefix = function () { return PartsVendors.CustomerDefineRow.localTextPrefix; };
            CustomerDefineGrid.prototype.getService = function () { return PartsVendors.CustomerDefineService.baseUrl; };
            return CustomerDefineGrid;
        }(Serenity.EntityGrid));
        CustomerDefineGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], CustomerDefineGrid);
...
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var ExchangeRateDialog = (function (_super) {
            __extends(ExchangeRateDialog, _super);
            function ExchangeRateDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new PartsVendors.ExchangeRateForm(_this.idPrefix);
                return _this;
            }
            ExchangeRateDialog.prototype.getFormKey = function () { return PartsVendors.ExchangeRateForm.formKey; };
            ExchangeRateDialog.prototype.getIdProperty = function () { return PartsVendors.ExchangeRateRow.idProperty; };
            ExchangeRateDialog.prototype.getLocalTextPrefix = function () { return PartsVendors.ExchangeRateRow.localTextPrefix; };
            ExchangeRateDialog.prototype.getNameProperty = function () { return PartsVendors.ExchangeRateRow.nameProperty; };
            ExchangeRateDialog.prototype.getService = function () { return PartsVendors.ExchangeRateService.baseUrl; };
        ...
        PartsVendors.ExchangeRateDialog = ExchangeRateDialog;
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var ExchangeRateGrid = (function (_super) {
            __extends(ExchangeRateGrid, _super);
            function ExchangeRateGrid(container) {
                return _super.call(this, container) || this;
            }
            ExchangeRateGrid.prototype.getColumnsKey = function () { return 'PartsVendors.ExchangeRate'; };
            ExchangeRateGrid.prototype.getDialogType = function () { return PartsVendors.ExchangeRateDialog; };
            ExchangeRateGrid.prototype.getIdProperty = function () { return PartsVendors.ExchangeRateRow.idProperty; };
            ExchangeRateGrid.prototype.getLocalTextPrefix = function () { return PartsVendors.ExchangeRateRow.localTextPrefix; };
            ExchangeRateGrid.prototype.getService = function () { return PartsVendors.ExchangeRateService.baseUrl; };
            return ExchangeRateGrid;
        }(Serenity.EntityGrid));
        ExchangeRateGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], ExchangeRateGrid);
        PartsVendors.ExchangeRateGrid = ExchangeRateGrid;
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var ShipmentDialog = (function (_super) {
            __extends(ShipmentDialog, _super);
            function ShipmentDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new PartsVendors.ShipmentForm(_this.idPrefix);
                return _this;
            }
            ShipmentDialog.prototype.getFormKey = function () { return PartsVendors.ShipmentForm.formKey; };
            ShipmentDialog.prototype.getIdProperty = function () { return PartsVendors.ShipmentRow.idProperty; };
            ShipmentDialog.prototype.getLocalTextPrefix = function () { return PartsVendors.ShipmentRow.localTextPrefix; };
            ShipmentDialog.prototype.getNameProperty = function () { return PartsVendors.ShipmentRow.nameProperty; };
            ShipmentDialog.prototype.getService = function () { return PartsVendors.ShipmentService.baseUrl; };
        ...
        PartsVendors.ShipmentDialog = ShipmentDialog;
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var ShipmentGrid = (function (_super) {
            __extends(ShipmentGrid, _super);
            function ShipmentGrid(container) {
                return _super.call(this, container) || this;
            }
            ShipmentGrid.prototype.getColumnsKey = function () { return 'PartsVendors.Shipment'; };
            ShipmentGrid.prototype.getDialogType = function () { return PartsVendors.ShipmentDialog; };
            ShipmentGrid.prototype.getIdProperty = function () { return PartsVendors.ShipmentRow.idProperty; };
            ShipmentGrid.prototype.getLocalTextPrefix = function () { return PartsVendors.ShipmentRow.localTextPrefix; };
            ShipmentGrid.prototype.getService = function () { return PartsVendors.ShipmentService.baseUrl; };
            return ShipmentGrid;
        }(Serenity.EntityGrid));
        ShipmentGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], ShipmentGrid);
        PartsVendors.ShipmentGrid = ShipmentGrid;
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var TypeDialog = (function (_super) {
            __extends(TypeDialog, _super);
            function TypeDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new PartsVendors.TypeForm(_this.idPrefix);
                return _this;
            }
            TypeDialog.prototype.getFormKey = function () { return PartsVendors.TypeForm.formKey; };
            TypeDialog.prototype.getIdProperty = function () { return PartsVendors.TypeRow.idProperty; };
            TypeDialog.prototype.getLocalTextPrefix = function () { return PartsVendors.TypeRow.localTextPrefix; };
            TypeDialog.prototype.getNameProperty = function () { return PartsVendors.TypeRow.nameProperty; };
            TypeDialog.prototype.getService = function () { return PartsVendors.TypeService.baseUrl; };
            return TypeDialog;
        }(Serenity.EntityDialog));
        TypeDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], TypeDialog);
        PartsVendors.TypeDialog = TypeDialog;
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var TypeGrid = (function (_super) {
            __extends(TypeGrid, _super);
            function TypeGrid(container) {
                return _super.call(this, container) || this;
            }
            TypeGrid.prototype.getColumnsKey = function () { return 'PartsVendors.Type'; };
            TypeGrid.prototype.getDialogType = function () { return PartsVendors.TypeDialog; };
            TypeGrid.prototype.getIdProperty = function () { return PartsVendors.TypeRow.idProperty; };
            TypeGrid.prototype.getLocalTextPrefix = function () { return PartsVendors.TypeRow.localTextPrefix; };
            TypeGrid.prototype.getService = function () { return PartsVendors.TypeService.baseUrl; };
            return TypeGrid;
        }(Serenity.EntityGrid));
        TypeGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], TypeGrid);
        PartsVendors.TypeGrid = TypeGrid;
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var UnitsDialog = (function (_super) {
            __extends(UnitsDialog, _super);
            function UnitsDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new PartsVendors.UnitsForm(_this.idPrefix);
                return _this;
            }
            UnitsDialog.prototype.getFormKey = function () { return PartsVendors.UnitsForm.formKey; };
            UnitsDialog.prototype.getIdProperty = function () { return PartsVendors.UnitsRow.idProperty; };
            UnitsDialog.prototype.getLocalTextPrefix = function () { return PartsVendors.UnitsRow.localTextPrefix; };
            UnitsDialog.prototype.getNameProperty = function () { return PartsVendors.UnitsRow.nameProperty; };
            UnitsDialog.prototype.getService = function () { return PartsVendors.UnitsService.baseUrl; };
            return UnitsDialog;
        }(Serenity.EntityDialog));
        ...
        PartsVendors.UnitsDialog = UnitsDialog;
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var PartsVendors;
    (function (PartsVendors) {
        var UnitsGrid = (function (_super) {
            __extends(UnitsGrid, _super);
            function UnitsGrid(container) {
                return _super.call(this, container) || this;
            }
            UnitsGrid.prototype.getColumnsKey = function () { return 'PartsVendors.Units'; };
            UnitsGrid.prototype.getDialogType = function () { return PartsVendors.UnitsDialog; };
            UnitsGrid.prototype.getIdProperty = function () { return PartsVendors.UnitsRow.idProperty; };
            UnitsGrid.prototype.getLocalTextPrefix = function () { return PartsVendors.UnitsRow.localTextPrefix; };
            UnitsGrid.prototype.getService = function () { return PartsVendors.UnitsService.baseUrl; };
            return UnitsGrid;
        }(Serenity.EntityGrid));
        UnitsGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], UnitsGrid);
        PartsVendors.UnitsGrid = UnitsGrid;
    })(PartsVendors = TemcoPartsVendors.PartsVendors || (TemcoPartsVendors.PartsVendors = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
//# sourceMappingURL=TemcoPartsVendors.Web.js.map