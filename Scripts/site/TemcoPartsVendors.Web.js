...
(function (TemcoPartsVendors) {
    ...
    })(BasicSamples = TemcoPartsVendors.BasicSamples || (TemcoPartsVendors.BasicSamples = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var BasicSamples;
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return TemcoPartsVendors.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = TemcoPartsVendors.BasicSamples || (TemcoPartsVendors.BasicSamples = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return TemcoPartsVendors.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return TemcoPartsVendors.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = TemcoPartsVendors.BasicSamples || (TemcoPartsVendors.BasicSamples = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return TemcoPartsVendors.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return TemcoPartsVendors.StaticTextBlock; }], ['FromLocalText', function () { return TemcoPartsVendors.StaticTextBlock; }], ['DisplayFieldValue', function () { return TemcoPartsVendors.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = TemcoPartsVendors.BasicSamples || (TemcoPartsVendors.BasicSamples = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
...
(function (TemcoPartsVendors) {
    ...
    })(Meeting = TemcoPartsVendors.Meeting || (TemcoPartsVendors.Meeting = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var Meeting;
...
(function (TemcoPartsVendors) {
    ...
    })(Northwind = TemcoPartsVendors.Northwind || (TemcoPartsVendors.Northwind = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var Northwind;
...
(function (TemcoPartsVendors) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'TemcoPartsVendors.Northwind.Entities.Gender');
    })(Northwind = TemcoPartsVendors.Northwind || (TemcoPartsVendors.Northwind = {}));
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        }(TemcoPartsVendors.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(TemcoPartsVendors.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(TemcoPartsVendors.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        }(TemcoPartsVendors.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        TemcoPartsVendors.Common.ReportHelper.execute({
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: TemcoPartsVendors.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: TemcoPartsVendors.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new TemcoPartsVendors.Northwind.OrderDialog();
                        ...
                        var chai = TemcoPartsVendors.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = TemcoPartsVendors.Northwind.EmployeeRow.getLookup().items
        ...
        }(TemcoPartsVendors.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(TemcoPartsVendors.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        }(TemcoPartsVendors.Northwind.OrderDialog));
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    TemcoPartsVendors.Northwind.CategoryService.Retrieve({
        ...
        }(TemcoPartsVendors.Northwind.CategoryDialog));
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        }(TemcoPartsVendors.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(TemcoPartsVendors.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new TemcoPartsVendors.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                TemcoPartsVendors.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(TemcoPartsVendors.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    TemcoPartsVendors.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(TemcoPartsVendors.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(TemcoPartsVendors.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    TemcoPartsVendors.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return TemcoPartsVendors.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return TemcoPartsVendors.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return TemcoPartsVendors.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return TemcoPartsVendors.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return TemcoPartsVendors.LanguageList.getValue();
            };
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        }(TemcoPartsVendors.Northwind.SupplierDialog));
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = (function (_super) {
            ...
            return ReadOnlyGrid;
        }(TemcoPartsVendors.Northwind.SupplierGrid));
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return TemcoPartsVendors.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return TemcoPartsVendors.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return TemcoPartsVendors.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return TemcoPartsVendors.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return TemcoPartsVendors.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                TemcoPartsVendors.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    TemcoPartsVendors.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(TemcoPartsVendors.Northwind.CustomerDialog));
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        }(TemcoPartsVendors.Northwind.CustomerGrid));
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = TemcoPartsVendors.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return TemcoPartsVendors.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(TemcoPartsVendors.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return TemcoPartsVendors.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new TemcoPartsVendors.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = TemcoPartsVendors.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(TemcoPartsVendors.Northwind.OrderDetailDialog));
...
(function (TemcoPartsVendors) {
    ...
    (function (Northwind) {
        ...
        }(TemcoPartsVendors.Common.GridEditorBase));
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        }(TemcoPartsVendors.Northwind.OrderDetailsEditor));
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return TemcoPartsVendors.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return TemcoPartsVendors.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return TemcoPartsVendors.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return TemcoPartsVendors.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return TemcoPartsVendors.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (TemcoPartsVendors) {
    ...
    TemcoPartsVendors.StaticTextBlock = StaticTextBlock;
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
var TemcoPartsVendors;
(function (TemcoPartsVendors) {
    var BasicSamples;
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        ...
        }(TemcoPartsVendors.Common.BulkServiceAction));
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return TemcoPartsVendors.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return TemcoPartsVendors.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return TemcoPartsVendors.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return TemcoPartsVendors.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = TemcoPartsVendors.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = TemcoPartsVendors.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(TemcoPartsVendors.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new TemcoPartsVendors.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new TemcoPartsVendors.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new TemcoPartsVendors.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, TemcoPartsVendors.Northwind.OrderRow.Fields.ShipCountry);
...
(function (TemcoPartsVendors) {
    ...
    TemcoPartsVendors.SelectableEntityGrid = SelectableEntityGrid;
})(TemcoPartsVendors || (TemcoPartsVendors = {}));
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return TemcoPartsVendors.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return TemcoPartsVendors.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return TemcoPartsVendors.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return TemcoPartsVendors.Northwind.SupplierService.baseUrl; };
            return RowSelectionGrid;
        }(TemcoPartsVendors.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = TemcoPartsVendors.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            TemcoPartsVendors.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return TemcoPartsVendors.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return TemcoPartsVendors.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return TemcoPartsVendors.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return TemcoPartsVendors.Northwind.ProductService.baseUrl; };
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return TemcoPartsVendors.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return TemcoPartsVendors.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return TemcoPartsVendors.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return TemcoPartsVendors.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return TemcoPartsVendors.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return TemcoPartsVendors.Northwind.CustomerGrossSalesRow.localTextPrefix; };
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: TemcoPartsVendors.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (TemcoPartsVendors) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return TemcoPartsVendors.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return TemcoPartsVendors.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return TemcoPartsVendors.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: TemcoPartsVendors.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = TemcoPartsVendors.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: TemcoPartsVendors.Authorization.userDefinition.DisplayName,
